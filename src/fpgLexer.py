...
class fpgLexerToken(object):
  """A token returned by fpgLexer.  The minimal token has a token name, value, and location."""
  ...
  def __init__(self, token=None, value=None, location=None):
    ...
    if isinstance(token,fpgLexerToken):
...
class fpgLexer(object):
  """The fpgLexer lexer class.  This contains the tables for the lexer, plus the lexer code itself."""
...
'%initial':u'normal',
u'normal':[
(None,(((9,10),24),((32,32),24),((34,34),22),((36,36),20),((37,37),18),((39,39),15),((40,40),13),((41,41),12),((43,43),11),((44,44),10),((45,45),8),((48,57),7),((59,59),6),((60,60),4),((61,61),3),((65,90),2),((95,95),2),((97,122),2),((124,124),1))),
(17,()),
(1,(((48,57),2),((65,90),2),((95,95),2),((97,122),2))),
(3,()),
(None,(((45,45),5),)),
(15,()),
(18,()),
(4,(((48,57),7),)),
(None,(((48,57),7),((62,62),9))),
...
(7,(((58,58),14),)),
((u'%skip',(u'(',u'push',(u'comment',))),()),
(None,(((0,38),15),((39,39),17),((40,91),15),((92,92),16),((93,1114111),15))),
(None,(((0,9),15),((11,1114111),15))),
(6,(((34,34),22),((39,39),15))),
(None,(((97,122),19),)),
(2,(((97,122),19),)),
(None,(((48,57),21),)),
(5,(((48,57),21),)),
(None,(((0,33),22),((34,34),17),((35,91),22),((92,92),23),((93,1114111),22))),
(None,(((0,9),22),((11,1114111),22))),
(u'%skip',(((9,10),24),((32,32),24)))
],
'%tokens':[
u'%eof',
u'C_TOKEN',
...
(u'%skip',())
  ...
  def next_token(self):
    """Return the next token from the source.  It will either return a fpgLexerToken object with a valid token, an %eof token, or an %error token, or it will return None if we have no valid source stream to read from."""
    ...
    while 1:
      ...
      # the next state machine run.
        ...
        token = fpgLexerToken(token=tkn, value=val, location=loc)
      ...
      # lookahead buffer, then that other stuff caused a syntax error).
        ...
        if len(self.source) == 0:
          token = u'%eof'
          return fpgLexerToken(token=self.tables[u'%tokenmap'][token], value=token, location=loc)
      ...
      # passed any accept states.  This is a syntax error.
        ...
        loc = self.lookahead[0][0][1]
        token = fpgLexerToken(token=u'%error', value=val, location=loc)
